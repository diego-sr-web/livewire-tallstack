...
final class ListMailMarketing extends PowerGridComponent
{
    use WithExport;
    ...
    {
        return MailMarketingTemplate::query();
    }
    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('preheader')
            ->addColumn('subject')
            ->addColumn('status', function (MailMarketingTemplate $model) {
    ...
    {
        try {
            return redirect()->route('mail-marketing.edit', $id);                   
        } catch (\Exception $e) {
            $this->dialog()->error(
                $title = 'Erro !!!',
    ...
    public function deleteConfirmation($id): void
    {
        ...
        $model = MailMarketingTemplate::find($id);
