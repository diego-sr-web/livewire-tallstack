...
use App\Models\Permissions\Role as Role;
...
final class ListRole extends PowerGridComponent
{
    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ->addColumn('id')
            ->addColumn('name')
            ->addColumn('status', function (Role $model) {
                return $model->active ? 'Ativo' : 'Inativo';
            })
            ->addColumn('is_admin', function (Role $model) {
                return $model->is_admin ? 'Sim' : 'Não';
            });
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Ativo', 'status')
                ->searchable()
                ->sortable(),
            
            Column::make('Perfil Admin?', 'is_admin')
                ->searchable()
                ->sortable(),
        ];
    }
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Editar')
                ...
                ->openModal('admin.roles.role.form', ['role' => 'id']),
