  ...
  <div class="main-home-wrapper">
    ...
    <div class="main-home-content-table p-5 overflow-hidden flex flex-col md:flex-row">
      ...
      <div class="w-full md:w-2/3 p-3">
        <div>
          <h2 class="text-2xl font-bold mb-4">Email - Transactional</h2>
          <form method="POST" action="{{ route('mail-transactional.store') }}">
            @csrf
            <input type="hidden" name="page" value="mail-transactional">
            ...
            <div>
              ...
              <div class="mt-4">
                <label for="subject" class="block font-medium text-gray-700">Pré-Header</label>
              ...
              <div class="mt-4">
                ...
                <textarea id="editor" name="body" placeholder="HTML da Template" class="mt-1 p-2 border rounded-lg w-full h-48"></textarea>
              </div>

              <div class="flex justify-between mt-4">
                <div>
                  <a href="{{ route('mail-transactional.index') }}" class="text-blue-500 hover:underline ml-2">Voltar</a>
                </div>

                <div>
                  <button type="submit" class="ml-auto bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Enviar</button>
                </div>
              </div>
            </div>
          </form>
