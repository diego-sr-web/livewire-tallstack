  ...
  <div class="main-home-wrapper">     
    ...
    <div class="main-home-content-table p-5 overflow-hidden flex flex-col md:flex-row">
      ...
      <div class="w-full md:w-2/3 p-3">
        <div>
          <form action="{{ route('mail-transactional.update', ['id' => $mailTemplate->id]) }}" method="POST">
            
            @csrf
            @method('PUT')
            <div>
                <h2 class="text-2xl font-bold mb-4">Mail - Transacional</h2>
            </div>
            ...
            <div class="mt-4">
                ...
                <input type="text" id="subject" name="preheader" value="{{ $mailTemplate->subject }}" placeholder="Breve introdução do e-mail." class="mt-1 p-2 border rounded-lg w-full" maxlength="140"/>
            </div>
            <div class="mt-4">
            ...
            <div class="flex justify-between mt-4">
                <div>
                    <a href="{{ route('mail-transactional.index') }}" class="text-blue-500">Voltar</a>
                </div>
                <div>
